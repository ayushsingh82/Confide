...
const plans = [
  {
    ...
    price: "$20",
    per: " to start",
    cta: "Get prepaid credits",
    popular: false,
    features: [
      "Prepaid credits, no subscription",
      "Provider cost + transparent 10% markup",
      "All four confidential models",
      "Receipts stored per request",
    ],
  },
  {
    name: "Pro",
    ...
    popular: true,
    features: [
      "Unlimited attested inference",
      "Per-seat audit dashboards",
      "Priority enclaves & queue",
      "Email + Slack support",
    ],
  },
  {
    name: "Enterprise",
    description: "For defense & restricted",
    price: "$2,150",
    per: "/seat / mo",
    cta: "Book a demo",
    popular: false,
    features: [
      "400 hours of agent runtime per seat",
